...
// import 'dart:async';
// import 'dbModel.dart';
// import 'dbmodel/user_details_db_model.dart';

// class UserDetailesDbHelper {
//   static final UserDetailesDbHelper instance = UserDetailesDbHelper._instance();
//   static Database _db = null;
//   UserDetailesDbHelper._instance();
...
//   Future<List<UserDetailsDbModel>> getData() async {
//     final List<Map<String, dynamic>> physicalMapList = await userMapList();
//     final List<UserDetailsDbModel> houselist = [];
//     physicalMapList.forEach((element) {
//       houselist.add(UserDetailsDbModel.fromMap(element));
//     });
//     print(houselist);
//     return houselist;
//   }
...
//   Future<int> updateData(UserDetailsDbModel userDetailsDb) async {
//     Database db = await this.db;
