...
import 'package:socio_survey/main.dart' as s;
...
class _TransportationPageState extends State<TransportationPage> {
  ...
  TextEditingController margetAndShoppingDistanceController = TextEditingController();
  TextEditingController hospitalAndHelthDistanceController = TextEditingController();
  TextEditingController parkAndCinemaDistanceController = TextEditingController();
  ...
  List question2ChoicesCheckBox = ["Public Bus", "Private Car", "Shared Car", "Auto", "Two wheeler", "Rickshaw", "ToTo", "Others"];
  List question2ChoicesCheckBoxValue = [false, false, false, false, false, false, false, false];
  List question3Choices = ["Public Bus", "Private Car", "Shared Car", "Auto", "Two wheeler", "Rickshaw", "If Others"];
  List question4ChoicesCheckBox = ["2 Wheeler", "4 Wheeler", "Cycle", "Light and Heavy Vehicles", "None", "If Others, Specify"];
  List question4ChoicesCheckBoxValue = [false, false, false, false, false, false];
  List question5Choices = ["Rickshaw", "2 Wheeler", "4 Wheeler", "Cycle", "Bus", "Walk"];
  List question6Choices = ["Rickshaw", "2 Wheeler", "4 Wheeler", "Cycle", "Bus", "Walk"];
  List question7Choices = ["Rickshaw", "2 Wheeler", "4 Wheeler", "Cycle", "Bus", "Walk"];
  List question9Choices = ["Rickshaw", "2 Wheeler", "4 Wheeler", "Cycle", "Bus", "Walk"];
  List question11Choices = ["Rickshaw", "2 Wheeler", "4 Wheeler", "Cycle", "Bus", "Walk"];
  List question12Choices = ["Rickshaw", "2 Wheeler", "4 Wheeler", "Cycle", "Bus", "Walk"];
  List question14Choices = ["Rickshaw", "2 Wheeler", "4 Wheeler", "Cycle", "Bus", "Walk"];
  List question16Choices = ["Rickshaw", "2 Wheeler", "4 Wheeler", "Cycle", "Bus", "Walk"];
  List question18Choices = ["Once in a year", "Once in 6 Months", "Once in 3 Months", "Every Month"];
  ...
  void setData() {
    ...
    question1GroupValue = s.surveyModel.areTransportationAndConveyanceFacilitiesSatisfactory;
    question2ChoicesCheckBoxValue =
        enableCheckBoxValue(s.surveyModel.beforeCovid19TheMostPreferredModeOfTransport, question2ChoicesCheckBox, question2ChoicesCheckBoxValue);
    question4ChoicesCheckBoxValue = enableCheckBoxValue(s.surveyModel.selfOwnedVehicles, question4ChoicesCheckBox, question4ChoicesCheckBoxValue);
    question3GroupValue = s.surveyModel.afterCovid19TheMostPreferredModeOfTransport;
    question5GroupValue = s.surveyModel.modeOfTransportationPreferForSchoolOrCollege;
    schoolDistanceController.text = s.surveyModel.distanceForSchoolCollege;
    schoolDistanceController.text = s.surveyModel.distanceForSchoolCollege ?? '';
    question5GroupValue = s.surveyModel.modeOfTransportationPreferForMarketOrShoppingCentre;
    margetAndShoppingDistanceController.text = s.surveyModel.distanceForMarketOrShoppingCentre;
    question7GroupValue = s.surveyModel.modeOfTransportationPreferForHospitalOrHealthCentre;
    hospitalAndHelthDistanceController.text = s.surveyModel.distanceForHospitalOrHealthCentre;
    question9GroupValue = s.surveyModel.modeOfTransportationPreferForParksCinemaMall;
    parkAndCinemaDistanceController.text = s.surveyModel.distanceForParksCinemaMall;
    question11GroupValue = s.surveyModel.modeOfTransportationForRailwayStationOrBusTerminal;
    railwayDistanceController.text = s.surveyModel.distanceForRailwayStationOrBusTerminal;
    question12GroupValue = s.surveyModel.modeOfTransportationPreferForAirport;
    airportDistanceController.text = s.surveyModel.distanceForAirport;
    question16GroupValue = s.surveyModel.modeOfTransportationPreferForBankOrPostoffice;
    bankDistanceController.text = s.surveyModel.distanceForBankOrPostoffice;
    question18GroupValue = s.surveyModel.howOftenDoYouTravelOutstation;
    question19GroupValue = s.surveyModel.locationOfOutstation;
    preferredModeController.text = s.surveyModel.preferredModeOfTransportationForOutstation;
    question21GroupValue = s.surveyModel.areThereAnySignagesProvided;
    question22GroupValue = s.surveyModel.isThereAnyFootpathProvided;
    question23GroupValue = s.surveyModel.isZebraCrossingProvidedNearJunctions;
    question24GroupValue = s.surveyModel.availabilityOfCycleTrackAndPedestrianPathway;
    question25GroupValue = s.surveyModel.ifYesIsThePathShadedWithTrees;
    anyFurtherController.text = s.surveyModel.anyFurtherSuggestionForImprovement;
    setState(() {});
  }
  ...
  Future postMethod() async {
    try {
      ...
      var data = {
        "survey_id": surveyId,
        "are_transportation_and_conveyance_facilities_satisfactory": question1GroupValue,
        "before_Covid19_the_most_preferred_mode_of_transport": getCheckBoxValues(question2ChoicesCheckBox, question2ChoicesCheckBox),
        "after_covid19_the_most_preferred_mode_of_transport": question3GroupValue,
        "self_owned_vehicles": getCheckBoxValues(question4ChoicesCheckBox, question4ChoicesCheckBox),
        "mode_of_transportation_prefer_for_school_or_college": question5GroupValue,
        "distance_for_school_college": schoolDistanceController.text,
        "mode_of_transportation_prefer_for_market_or_shopping_centre": question5GroupValue,
        "distance_for_market_or_shopping_centre": margetAndShoppingDistanceController.text,
        "mode_of_transportation_prefer_for_hospital_or_health_centre": question7GroupValue,
        "distance_for_hospital_or_health_centre": hospitalAndHelthDistanceController.text,
        "mode_of_transportation_prefer_for_parks_cinema_mall": question9GroupValue,
        "distance_for_parks_cinema_mall": parkAndCinemaDistanceController.text,
        "mode_of_transportation_for_railway_station_or_bus_terminal": question11GroupValue,
        "distance_for_railway_station_or_bus_terminal": railwayDistanceController.text,
        "mode_of_transportation_prefer_for_airport": question12GroupValue,
        "distance_for_airport": airportDistanceController.text,
        "mode_of_transportation_prefer_for_bank_or_postoffice": question16GroupValue,
        ...
        "preferred_mode_of_transportation_for_outstation": preferredModeController.text,
        ...
        "availability_of_cycle_track_and_pedestrian_pathway": question24GroupValue,
      ...
      if (deviceResponseTransport.data[0].transportation_status == "1" || deviceResponseTransport.data[0].transportation_status != null) {
        ...
        print("in if");
        print(data);
        response = await http.put(Uri.parse('http://13.232.140.106:5000/rsi-field-force-api/transportation?survey_id=$surveyId'),
            headers: <String, String>{
              'Content-Type': 'application/json; charset=UTF-8',
            },
        ...
        response = await http.post(Uri.parse('http://13.232.140.106:5000/rsi-field-force-api/transportation'),
            headers: <String, String>{
              'Content-Type': 'application/json; charset=UTF-8',
            },
            body: json.encode(data));
        ...
        child: SingleChildScrollView(
          ...
          questionBody: Column(children: [
            ...
            QuestionContainer(
                child: Column(
              children: [
                const QuestionName(questionName: TransportationQuestion.areTransportationConveyance),
            ...
            QuestionContainer(
                child: Column(
              children: [
                const QuestionName(questionName: TransportationQuestion.beforeCovid),
                ...
                (question2ChoicesCheckBoxValue[7] && question2ChoicesCheckBox.contains("Others"))
                    ? TextFieldContainer(
            ...
            QuestionContainer(
                child: Column(
              children: [
                const QuestionName(questionName: TransportationQuestion.afterCovid),
            ...
            QuestionContainer(
                child: Column(
              children: [
                const QuestionName(questionName: TransportationQuestion.selfOwendVehicle),
                ...
                (question4ChoicesCheckBoxValue[5] && question4ChoicesCheckBox.contains("If Others, Specify"))
                    ? TextFieldContainer(
            ...
            QuestionContainer(
                child: Column(
              children: [
                const QuestionName(questionName: TransportationQuestion.modeSchoolAndCollege),
            ...
            QuestionContainer(
                child: Column(
              children: [
                const QuestionName(questionName: TransportationQuestion.distanceSchoolAndCollege),
                TextFieldContainer(
            ...
            QuestionContainer(
                child: Column(
              children: [
                const QuestionName(questionName: TransportationQuestion.modeMargetAndShopping),
            ...
            QuestionContainer(
                child: Column(
              children: [
                const QuestionName(questionName: TransportationQuestion.distanceMargetAndShopping),
                TextFieldContainer(
            ...
            QuestionContainer(
                child: Column(
              children: [
                const QuestionName(questionName: TransportationQuestion.modeHospitalAndHelth),
            ...
            QuestionContainer(
                child: Column(
              children: [
                const QuestionName(questionName: TransportationQuestion.distanceHospitalAndHelth),
                TextFieldContainer(
            ...
            QuestionContainer(
                child: Column(
              children: [
                const QuestionName(questionName: TransportationQuestion.modeParksAndCineme),
            ...
            QuestionContainer(
                child: Column(
              children: [
                const QuestionName(questionName: TransportationQuestion.distanceParksAndCineme),
                TextFieldContainer(
            ...
            QuestionContainer(
                child: Column(
              children: [
                const QuestionName(questionName: TransportationQuestion.modeRailwayAndBus),
            ...
            QuestionContainer(
                child: Column(
              children: [
                const QuestionName(questionName: TransportationQuestion.distanceRailwayAndBus),
                TextFieldContainer(
            ...
            QuestionContainer(
                child: Column(
              children: [
                const QuestionName(questionName: TransportationQuestion.modeAirport),
            ...
            QuestionContainer(
                child: Column(
              children: [
                const QuestionName(questionName: TransportationQuestion.distanceAirport),
                TextFieldContainer(
            ...
            QuestionContainer(
                child: Column(
              children: [
                const QuestionName(questionName: TransportationQuestion.modeBankAndPost),
            ...
            QuestionContainer(
                child: Column(
              children: [
                const QuestionName(questionName: TransportationQuestion.distanceBankAndPost),
                TextFieldContainer(
            ...
            QuestionContainer(
                child: Column(
              children: [
                const QuestionName(questionName: TransportationQuestion.howOftenTravel),
            ...
            QuestionContainer(
                child: Column(
              children: [
                const QuestionName(questionName: TransportationQuestion.locationOutstation),
            ...
            QuestionContainer(
                child: Column(
              children: [
                const QuestionName(questionName: TransportationQuestion.preferredTransportationOutation),
                TextFieldContainer(
            ...
            QuestionContainer(
                child: Column(
              children: [
                const QuestionName(questionName: TransportationQuestion.signageProvided),
            ...
            QuestionContainer(
                child: Column(
              children: [
                const QuestionName(questionName: TransportationQuestion.footpathProvided),
            ...
            QuestionContainer(
                child: Column(
              children: [
                const QuestionName(questionName: TransportationQuestion.zebraCrossingProvided),
            ...
            QuestionContainer(
                child: Column(
              children: [
                const QuestionName(questionName: TransportationQuestion.pedestrianPathway),
            ...
            if (question24GroupValue == "Yes")
              ...
              QuestionContainer(
                  child: Column(
                children: [
                  const QuestionName(questionName: TransportationQuestion.ifYesShadedTrees),
            ...
            QuestionContainer(
                child: Column(
              children: [
                const QuestionName(questionName: TransportationQuestion.anyFurtherImprovement),
                TextFieldContainer(
