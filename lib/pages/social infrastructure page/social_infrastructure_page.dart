...
class _SocialInfrastructurePageState extends State<SocialInfrastructurePage> {
  ...
  TextEditingController primarySchoolDistanceController =
      TextEditingController();
  TextEditingController collegeDistanceController = TextEditingController();
  TextEditingController higherSecondaryDistanceController =
      TextEditingController();
  TextEditingController mostPreferredController = TextEditingController();
  TextEditingController suggestionImprovementController1 =
      TextEditingController();
  TextEditingController pvtHospitalDistanceController = TextEditingController();
  TextEditingController govtHospitalDistanceController =
      TextEditingController();
  TextEditingController phcAndChcDistanceController = TextEditingController();
  TextEditingController suggestionImprovementController2 =
      TextEditingController();
  TextEditingController suggestionImprovementController3 =
      TextEditingController();
  ...
  List question14ChoicesCheckBoxValue = [
    false,
    false,
    false,
    false,
      ...
      children: [
        TextField(
          ...
          decoration: const InputDecoration(
              border: OutlineInputBorder(), hintText: 'Enter Distance'),
          onSubmitted: (val) {
            // setState(() {
    ...
    try {
      var data = {
        ...
        "which_type_of_schoolor_education_infrastructure_do_you_prefer":
            question1GroupValue,
        "type_of_education_availability_and_their_distance": "checkBox",
        ...
        "any_further_suggestions_or_issues_for_improvement_in_education":
            suggestionImprovementController1.text,
      ...
      var response;
      if (deviceResponseSocialInfrastructure.data[0].social_infrastructure_status == "1" || deviceResponseSocialInfrastructure.data[0].social_infrastructure_status != null) {
        print("in if");
        print(dataUpdate);
        response = await http.put(
            Uri.parse(
                'http://13.232.140.106:5000/rsi-field-force-api/social-infrastructure?survey_id=$surveyId'),
            headers: <String, String>{
              'Content-Type': 'application/json; charset=UTF-8',
            },
                ...
                children: [
                  ...
                  QuestionContainer(
                      child: Column(
                        children: [
                          const QuestionName(
                              questionName: SocialInfrastructureQuestion
                                  .whichTypeOfSchoolEducation),
                  ...
                  QuestionContainer(
                      child: Column(
                        children: [
                          ...
                          (question2ChoicesCheckBoxValue[0] &&
                              question2ChoicesCheckBox.contains("Anganwadi"))
                              ? TextFieldContainer(
                              controller: anganwadiDistanceController,
                              hint: "Enter Anganwadi Distance",
                              inputType: TextInputType.number)
                              : Container(),
                          (question2ChoicesCheckBoxValue[1] &&
                              question2ChoicesCheckBox.contains("Primary School"))
                              ? TextFieldContainer(
                              controller: primarySchoolDistanceController,
                              hint: "Enter Primary School Distance",
                              inputType: TextInputType.number)
                              : Container(),
                          (question2ChoicesCheckBoxValue[2] &&
                              question2ChoicesCheckBox.contains("Higher Secondary"))
                              ? TextFieldContainer(
                              controller: higherSecondaryDistanceController,
                              hint: "Enter Higher Secondary Distance",
                              inputType: TextInputType.number)
                              : Container(),
                          (question2ChoicesCheckBoxValue[3] &&
                              question2ChoicesCheckBox.contains("College"))
                              ? TextFieldContainer(
                              controller: collegeDistanceController,
                              hint: "Enter College Distance",
                              inputType: TextInputType.number)
                              : Container(),
                        ],
                      )),
                  ...
                  QuestionContainer(
                      child: Column(
                        children: [
                          const QuestionName(
                              questionName:
                              SocialInfrastructureQuestion.mostPreferredMode),
                  ...
                  QuestionContainer(
                      child: Column(
                        children: [
                          const QuestionName(
                              questionName:
                              SocialInfrastructureQuestion.doYouThinkThatYourRegion),
                  ...
                  QuestionContainer(
                      child: Column(
                        children: [
                          const QuestionName(
                              questionName:
                              SocialInfrastructureQuestion.anyFurtherSuggestions),
                          TextFieldContainer(
                  ...
                  QuestionContainer(
                      child: Column(
                        children: [
                          const QuestionName(
                              questionName: SocialInfrastructureQuestion.distance),
                          ...
                          (question7ChoicesCheckBoxValue[0] &&
                              question7ChoicesCheckBox.contains("Pvt. Hospital"))
                              ? TextFieldContainer(
                            ...
                            inputType: TextInputType.number,
                              ...
                              : Container(),
                          (question7ChoicesCheckBoxValue[1] &&
                              question7ChoicesCheckBox.contains("Govt. Hospital"))
                              ? TextFieldContainer(
                            ...
                            inputType: TextInputType.number,
                              ...
                              : Container(),
                          (question7ChoicesCheckBoxValue[2] &&
                              question7ChoicesCheckBox.contains("PHC / CHC"))
                              ? TextFieldContainer(
                  ...
                  QuestionContainer(
                      child: Column(
                        children: [
                          const QuestionName(
                              questionName: SocialInfrastructureQuestion
                                  .goodOpportunitiesHealthFacilities),
                  ...
                  QuestionContainer(
                      child: Column(
                        children: [
                          const QuestionName(
                              questionName:
                              SocialInfrastructureQuestion.doYouOrYourFamilyMembers),
                    ...
                    QuestionContainer(
                        child: Column(
                          children: [
                            const QuestionName(
                                questionName:
                                SocialInfrastructureQuestion.ifYesHowRegular),
                  ...
                  QuestionContainer(
                      child: Column(
                        children: [
                          const QuestionName(
                              questionName:
                              SocialInfrastructureQuestion.anyFurtherImprovement),
                          TextFieldContainer(
                  ...
                  QuestionContainer(
                      child: Column(
                        children: [
                          QuestionName(
                              questionName:
                              SocialInfrastructureQuestion.receiceAnyGrantAnyState),
                          ...
                          (question14ChoicesCheckBoxValue[8] &&
                              question14ChoicesCheckBox.contains("Others"))
                              ? TextFieldContainer(
                  ...
                  QuestionContainer(
                      child: Column(
                        children: [
                          const QuestionName(
                              questionName: SocialInfrastructureQuestion
                                  .ifAvailingAnyOtherShemesPleaseSpecify),
                          TextFieldContainer(
