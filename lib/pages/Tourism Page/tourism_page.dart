...
class _TourismPageState extends State<TourismPage> {
  ...
  TextEditingController anyFurtherSuggestionController =
    ...
    try {
      var data = {
        ...
        "which_type_of_activities_youre_involved_in":
            whichTypeActivitesController.text,
        "any_other_work_engagement_apart_from_tourist_activity":
            "${duringSessionController.text + "," + leanSessionController.text}",
      ...
      if (deviceResponseTourist.data[0].tourism_status == "1" || deviceResponseTourist.data[0].tourism_status != null) {
        ...
        response = await http.put(
            Uri.parse(
                'http://13.232.140.106:5000/rsi-field-force-api/tourism?survey_id=$surveyId'),
            headers: <String, String>{
              'Content-Type': 'application/json; charset=UTF-8',
            },
        ...
        response = await http.post(
            Uri.parse(
                'http://13.232.140.106:5000/rsi-field-force-api/tourism'),
            headers: <String, String>{
              'Content-Type': 'application/json; charset=UTF-8',
            },
            body: json.encode(data));
              ...
              children: [
                ...
                QuestionContainer(
                    child: Column(
                      children: [
                        const QuestionName(
                            questionName: TourismQuestion.doTouristRegion),
                ...
                QuestionContainer(
                    child: Column(
                      children: [
                        const QuestionName(
                            questionName: TourismQuestion.bestSessionTourist),
                        TextFieldContainer(
                ...
                QuestionContainer(
                    child: Column(
                      children: [
                        const QuestionName(
                            questionName:
                            TourismQuestion.areYouInvolvedTouristActivities),
                ...
                QuestionContainer(
                    child: Column(
                      children: [
                        const QuestionName(
                            questionName: TourismQuestion.whichTypeOfActivites),
                        TextFieldContainer(
                ...
                QuestionContainer(
                    child: Column(
                      children: [
                        const QuestionName(
                            questionName: TourismQuestion.anyOtherEngagement),
                        SizedBox(
                          height: 10,
                        ),
                        const QuestionName(
                            questionName: TourismQuestion.duringTouringSeason),
                        TextFieldContainer(
                ...
                QuestionContainer(
                    child: Column(
                      children: [
                        const QuestionName(
                            questionName: TourismQuestion.noOfPersonSuchAct),
                        TextFieldContainer(
                ...
                QuestionContainer(
                    child: Column(
                      children: [
                        const QuestionName(
                            questionName: TourismQuestion.ifHandicraft),
                        TextFieldContainer(
                ...
                QuestionContainer(
                    child: Column(
                      children: [
                        const QuestionName(
                            questionName: TourismQuestion.whomDoYouSellProducts),
                        TextFieldContainer(
                ...
                QuestionContainer(
                    child: Column(
                      children: [
                        const QuestionName(
                            questionName: TourismQuestion.doYouParticipate),
                ...
                if (q9V == "Yes")
                  QuestionContainer(
                      child: Column(
                        children: [
                          const QuestionName(
                              questionName: TourismQuestion.ifYesWhereAndHowOften),
                          SizedBox(
                            height: 10,
                          ),
                          ...
                          const QuestionName(
                              questionName: TourismQuestion.kolkataFair),
                          TextFieldContainer(
                            controller: kolkataFairController,
                            hint: "Enter Text",
                          ),
                          const QuestionName(
                              questionName: TourismQuestion.intraState),
                          TextFieldContainer(
                ...
                QuestionContainer(
                    child: Column(
                      children: [
                        const QuestionName(
                            questionName: TourismQuestion.availabilityOfTraining),
                ...
                QuestionContainer(
                    child: Column(
                      children: [
                        const QuestionName(
                            questionName: TourismQuestion.sellOfProducts),
                        SizedBox(
                          height: 10,
                        ),
                        const QuestionName(
                            questionName: TourismQuestion.beforeCovid19),
                        TextFieldContainer(
                          controller: beforeCovidController,
                          hint: "Enter Text",
                        ),
                        const QuestionName(
                            questionName: TourismQuestion.afterCovid19),
                        TextFieldContainer(
                ...
                QuestionContainer(
                    child: Column(
                      children: [
                        const QuestionName(
                            questionName: TourismQuestion.doYouThinkTourismSector),
                ...
                QuestionContainer(
                    child: Column(
                      children: [
                        const QuestionName(
                            questionName:
                            TourismQuestion.anyFurtherSuggestionForImprovement),
                        TextFieldContainer(
