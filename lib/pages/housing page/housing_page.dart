...
class _HousingPageState extends State<HousingPage> {
  ...
  List question1Choices = ["Semi Pukka House", "Pukka House", "Kaccha House", "Individual House", "Apartment"];
  List question2Choices = ["Single Storied (G+0)", "Two Storied (G+1)", "3 Storied (G+2)", "Multi Storied (G+3 and above)"];
  List question3Choices1 = ["Brick/ Stone", "Mud blocks/Bamboo", "Others, Specify"];
  List question3Choices2 = ["RCC", "Tin", "Tiles", "Others, Specify"];
  List question5Choices = ["Good", "Average", "Poor"];
  List question4Choices = ["0 - 5 Yrs", "5 -15 Yrs", "15 – 25 Yrs", "More than 25 yrs"];
  ...
  List question13Choices = ["Self Use", "Rent purpose", "Shop/Commercial", "Manufacturing Activity", "Government Office", "Private Office", "Other Specify"];
  ...
  List question15Choices = ["Cooking Gas / LPG", "Firewood", "Electric Induction", "Kerosene", "Cooking Coal", "If Other, Specify"];
  List question13ChoicesValue = [false, false, false, false, false, false, false];
  List question14ChoicesValue = [false, false, false, false, false, false, false, false, false];
  Housing housing;
  ...
  void setData() {
    ...
    question13ChoicesValue = enableCheckBoxValue(surveyModel.usageOfResidentialBuilding, question13Choices, question13ChoicesValue);
    question14ChoicesValue = enableCheckBoxValue(surveyModel.assetOwnedByHousehold, question14Choices, question14ChoicesValue);
    question1GroupValue = surveyModel.typeOfHouse;
    question2GroupValue = surveyModel.numberOfFloors;
    question3GroupValue1 = surveyModel.wall;
    question3GroupValue2 = surveyModel.roof;
    question4GroupValue = surveyModel.ageOfHouse;
    question5GroupValue = surveyModel.houseCondition;
    question6GroupValue = surveyModel.ownershipType;
    rentedAmountController.text = surveyModel.ifRentedAmount;
    question7GroupValue = surveyModel.landOwnership;
    approxPriceRangeController.text = surveyModel.approxPriceRangeOfLandPerKatha;
    question9GroupValue = surveyModel.doYouHaveAnyOtherLandProperty;
    landPropertyController.text = surveyModel.ifYesWhere;
    question12GroupValue = surveyModel.ifNoAreYouWillingToBuy;
    // qtn13Str = surveyModel.usageOfResidentialBuilding ;
    // qtn14Str = surveyModel.assetOwnedByHousehold ;
    residingBuildingVal = surveyModel.usageOfResidentialBuildingText;
    question15GroupValue = surveyModel.cookingFuelUsedInTheKitchen;
  }
  ...
  void setValuesToForm() {
    ...
    question15GroupValue =
        setRbAndText(question15Choices, housingPageResponse.data[0].cooking_fuel_used_in_the_kitchen, cookingFuelController, "If Other, Specify");
    ...
    final Map<int, String> values1 = {for (int i = 0; i < split1.length; i++) i: split1[i]};
  ...
  Future postMethod() async {
    ...
    try {
      ...
      print("Data == $qtn13Str");
      enableCheckBoxValue(qtn13Str, question13Choices, question13ChoicesValue);
      var dataUpdate = {
        // "survey_id": surveyId,
        "type_of_house": question1GroupValue,
        "number_of_floors": question2GroupValue,
      ...
      if (housingPageResponse.data[0].housing_status == "1" && housingPageResponse.data[0].housing_status != null) {
        print("in if");
        response = await http.put(Uri.parse('http://13.232.140.106:5000/rsi-field-force-api/housing?survey_id=$surveyId'),
        ...
        response = await http.post(Uri.parse('http://13.232.140.106:5000/rsi-field-force-api/housing'),
            headers: <String, String>{
              'Content-Type': 'application/json; charset=UTF-8',
            },
            body: bodyEncoded);
          ...
          questionBody: Column(
            children: [
              ...
              QuestionContainer(
                child: Column(
                  children: [
                    const QuestionName(questionName: HousingQuestion.numberOfFloors),
              ...
              QuestionContainer(
                  child: Column(
                children: [
                  const QuestionName(questionName: HousingQuestion.houseCondition),
              ...
              if (question6GroupValue == "Rented")
                QuestionContainer(
                  ...
                  children: [
                    const QuestionName(questionName: HousingQuestion.ifRentedAmount),
                    TextFieldContainer(
              ...
              QuestionContainer(
                  child: Column(
                children: [
                  QuestionName(questionName: HousingQuestion.doYouHaveLandProperty),
              ...
              QuestionContainer(
                  child: Column(
                children: [
                  QuestionName(questionName: HousingQuestion.usageResidentialBuilding),
                  ...
                  (question13ChoicesValue[6] && question13Choices.contains("Other Specify"))
                      ? TextFieldContainer(
