...
class EnvironmentalRelatedPage extends StatefulWidget {
  EnvironmentalRelatedPage({Key key,this.data}) : super(key: key);
final String data;
  @override
...
class _EnvironmentalRelatedPageState extends State<EnvironmentalRelatedPage> {
  ...
  TextEditingController anyFurtherSuggestionImprovementController =
      TextEditingController();
  List qtnCho3 = [
    "Transportation",
    "Industries",
    ...
    try {
      var data = {
        ...
        "if_yes_specify_issues_faced_in_rainy_season":
            doYouFaceIssueRainycontroller.text,
        ...
        "any_further_suggestion_for_improvement_in_environment":
            anyFurtherSuggestionImprovementController.text,
      ...
      if (deviceResponseEnvironment.data[0].environmental_related_status == "1" || deviceResponseEnvironment.data[0].environmental_related_status != null) {
        ...
        response = await http.put(
            Uri.parse(
                'http://13.232.140.106:5000/rsi-field-force-api/environmental-related?survey_id=$surveyId'),
            headers: <String, String>{
              'Content-Type': 'application/json; charset=UTF-8',
            },
                ...
                children: [
                  ...
                  QuestionContainer(
                      child: Column(
                        children: [
                          const QuestionName(
                              questionName: EnvironmentalQuestion.doesFamilyOrPerson),
                  ...
                  qtnGrpVal1 == "Yes"
                      ...
                      child: Column(
                        children: [
                          const QuestionName(
                              questionName:
                              EnvironmentalQuestion.ifYesWhichDiseases),
                          TextFieldContainer(
                  ...
                  QuestionContainer(
                      child: Column(
                        children: [
                          const QuestionName(
                              questionName:
                              EnvironmentalQuestion.doYouFamilyMemberProblemBrething),
                          for (var i = 0; i < qtnChoYesNo.length; i++)
                            RadioListTile(
                                tileColor: Colors.orangeAccent,
                                selectedTileColor: Colors.orangeAccent,
                  ...
                  QuestionContainer(
                      child: Column(
                        children: [
                          const QuestionName(
                              questionName: EnvironmentalQuestion.majorCausePollution),
                          ...
                          (qtnGrpVal3 == "If Other, Specify")
                              ? TextFieldContainer(
                              controller: majorCousePollutioncontroller,
                              hint: "Enter Text")
                              : Container(),
                        ],
                      )),
                  QuestionContainer(
                      child: Column(
                        children: [
                          const QuestionName(
                              questionName:
                              EnvironmentalQuestion.doYouFaceIssuesDuringRainy),
                          for (var i = 0; i < qtnChoYesNo.length; i++)
                            RadioListTile(
                                tileColor: Colors.orangeAccent,
                                selectedTileColor: Colors.orangeAccent,
                  ...
                  qtnGrpVal4 == "Yes"
                      ...
                      child: Column(
                        children: [
                          const QuestionName(
                              questionName: EnvironmentalQuestion.ifYesSpecify),
                          TextFieldContainer(
                  ...
                  QuestionContainer(
                      child: Column(
                        children: [
                          const QuestionName(
                              questionName: EnvironmentalQuestion.whetherTheAreProne),
                          for (var i = 0; i < qtnChoYesNo.length; i++)
                            RadioListTile(
                                tileColor: Colors.orangeAccent,
                                selectedTileColor: Colors.orangeAccent,
                  ...
                  qtnGrpVal5 == "Yes"
                      ...
                      child: Column(
                        children: [
                          const QuestionName(
                              questionName:
                              EnvironmentalQuestion.ifYesHowManyDaysNormal),
                  ...
                  QuestionContainer(
                      child: Column(
                        children: [
                          const QuestionName(
                              questionName: EnvironmentalQuestion.duringFlooding),
                          for (var i = 0; i < qtnChoYesNo.length; i++)
                            RadioListTile(
                                tileColor: Colors.orangeAccent,
                                selectedTileColor: Colors.orangeAccent,
                  ...
                  QuestionContainer(
                      child: Column(
                        children: [
                          const QuestionName(
                              questionName: EnvironmentalQuestion.whetherAnyFunds),
                          for (var i = 0; i < qtnChoYesNo.length; i++)
                            RadioListTile(
                                tileColor: Colors.orangeAccent,
                                selectedTileColor: Colors.orangeAccent,
                  ...
                  QuestionContainer(
                      child: Column(
                        children: [
                          const QuestionName(
                              questionName: EnvironmentalQuestion.doHoardings),
                          for (var i = 0; i < qtnChoYesNo.length; i++)
                            RadioListTile(
                                tileColor: Colors.orangeAccent,
                                selectedTileColor: Colors.orangeAccent,
                  ...
                  QuestionContainer(
                      child: Column(
                        children: [
                          const QuestionName(
                              questionName: EnvironmentalQuestion.doesTrafficMovement),
                          for (var i = 0; i < qtnChoYesNo.length; i++)
                            RadioListTile(
                                tileColor: Colors.orangeAccent,
                                selectedTileColor: Colors.orangeAccent,
                  ...
                  qtnGrpVal9 == "Yes"
                      ...
                      child: Column(
                        children: [
                          const QuestionName(
                              questionName:
                              EnvironmentalQuestion.ifAnySuggestionImprovement),
                          TextFieldContainer(
                  ...
                  QuestionContainer(
                      child: Column(
                        children: [
                          const QuestionName(
                              questionName: EnvironmentalQuestion.whetherWasteDisposed),
                          for (var i = 0; i < qtnChoYesNo.length; i++)
                            RadioListTile(
                                tileColor: Colors.orangeAccent,
                                selectedTileColor: Colors.orangeAccent,
                  ...
                  QuestionContainer(
                      child: Column(
                        children: [
                          QuestionName(
                              questionName:
                              EnvironmentalQuestion.anyFurtherSuggestionImprovment),
                          TextFieldContainer(
