...
class _CoastalPageState extends State<CoastalPage> {
  ...
  TextEditingController activitesApartFromFishingController =
      TextEditingController();
  TextEditingController informationRelatedThreatsController =
      TextEditingController();
  ...
  List q8Cho = [
    ...
    "TV",
    "Radio",
    "Local Administration Announcement",
    "NGO",
    "If other, Specify"
  ];
  String q8V;
    ...
    try {
      var data = {
        ...
        "if_yes_then_specify_as_seller_catcher_supplier_or_other":
           ifYesSpecifySellerController.text,
      ...
      if (deviceResponseCoastal.data[0].coastal_status == "1" || deviceResponseCoastal.data[0].coastal_status != null) {
        ...
        response = await http.put(
            Uri.parse(
                'http://13.232.140.106:5000/rsi-field-force-api/coastal?survey_id=$surveyId'),
            headers: <String, String>{
              'Content-Type': 'application/json; charset=UTF-8',
            },
        ...
        response = await http.post(
            Uri.parse(
                'http://13.232.140.106:5000/rsi-field-force-api/coastal'),
            headers: <String, String>{
              'Content-Type': 'application/json; charset=UTF-8',
            },
            body: json.encode(data));
              ...
              children: [
                ...
                QuestionContainer(
                    child: Column(
                      children: [
                        const QuestionName(
                            questionName: CoastalQuestion.doYouHaveBoats),
                ...
                if (q1V == "Yes")
                  QuestionContainer(
                      child: Column(
                        children: [
                          const QuestionName(
                              questionName: CoastalQuestion.ifYesPurposeUseBoats),
                ...
                QuestionContainer(
                    child: Column(
                      children: [
                        const QuestionName(
                            questionName: CoastalQuestion.areYouAssociatedFishing),
                  ...
                  QuestionContainer(
                      child: Column(
                        children: [
                          const QuestionName(
                              questionName:
                              CoastalQuestion.ifYesSpecifySellerOrOther),
                          TextFieldContainer(
                ...
                QuestionContainer(
                    child: Column(
                      children: [
                        const QuestionName(
                            questionName: CoastalQuestion.haveBeenEngaged),
                ...
                if (q5V == "Yes")
                  QuestionContainer(
                      child: Column(
                        children: [
                          const QuestionName(
                              questionName: CoastalQuestion.ifYesSpecify),
                          TextFieldContainer(
                ...
                QuestionContainer(
                    child: Column(
                      children: [
                        const QuestionName(
                            questionName: CoastalQuestion.doYouThinkLivingCoastal),
                ...
                QuestionContainer(
                    child: Column(
                      children: [
                        const QuestionName(
                            questionName: CoastalQuestion.howDoYouGetInformation),
                ...
                QuestionContainer(
                    child: Column(
                      children: [
                        const QuestionName(
                            questionName: CoastalQuestion.safePlaceNaturalEvents),
                ...
                QuestionContainer(
                    child: Column(
                      children: [
                        const QuestionName(
                            questionName: CoastalQuestion.afterNaturalDisaster),
                ...
                QuestionContainer(
                    child: Column(
                      children: [
                        const QuestionName(
                            questionName: CoastalQuestion.majorDamagesCalamities),
                ...
                QuestionContainer(
                    child: Column(
                      children: [
                        const QuestionName(
                            questionName: CoastalQuestion.availabilityRationDisaster),
                ...
                QuestionContainer(
                    child: Column(
                      children: [
                        const QuestionName(
                            questionName: CoastalQuestion.whetherFundAreaGranted),
                ...
                QuestionContainer(
                    child: Column(
                      children: [
                        const QuestionName(
                            questionName:
                            CoastalQuestion.doesThisRegionOpportunities),
                ...
                QuestionContainer(
                    child: Column(
                      children: [
                        const QuestionName(
                            questionName: CoastalQuestion.anyFurtherSuggestions),
                        TextFieldContainer(
