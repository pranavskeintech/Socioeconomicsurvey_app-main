...
class _PhysicalInfrastructurePageState
  ...
  List qtnCho16 = [
    "On site R.W.H",
    "Directly to public drains",
    "Discharged to river / Pond / Nalla"
  ];
  List qtnCho15 = [
    "Soak Pit",
    "Municipal Drainage",
...
*/
  ...
  Future postMethod() async {
    try {
      ...
      var response;
      if (deviceResponsePhyInfrastructure.data[0].physical_infrastructure_status == "1" || deviceResponsePhyInfrastructure.data[0].physical_infrastructure_status != null) {
        print("in if");
        print(dataUpdate);
        response = await http.put(
            Uri.parse(
                'http://13.232.140.106:5000/rsi-field-force-api/physical-infrastructure?survey_id=$surveyId'),
            headers: <String, String>{
              'Content-Type': 'application/json; charset=UTF-8',
            },
                ...
                children: [
                  ...
                  QuestionContainer(
                      child: Column(
                        children: [
                          const QuestionName(
                              questionName:
                              PhysicalInfrastructureQuestion.sourceOfDrinking),
                  ...
                  QuestionContainer(
                      child: Column(
                        children: [
                          const QuestionName(
                              questionName:
                              PhysicalInfrastructureQuestion.isConnectionPremises),
                  ...
                  QuestionContainer(
                      child: Column(
                        children: [
                          const QuestionName(
                              questionName:
                              PhysicalInfrastructureQuestion.frequencyMunicipal),
                  ...
                  QuestionContainer(
                      child: Column(
                        children: [
                          const QuestionName(
                              questionName:
                              PhysicalInfrastructureQuestion.durationSupply),
                  ...
                  QuestionContainer(
                      child: Column(
                        children: [
                          const QuestionName(
                              questionName:
                              PhysicalInfrastructureQuestion.qualityOfWater),
                  ...
                  QuestionContainer(
                      child: Column(
                        children: [
                          const QuestionName(
                              questionName:
                              PhysicalInfrastructureQuestion.areYouSatisfied),
                          for (var i = 0; i < qtnChoYesNo.length; i++)
                            RadioListTile(
                                tileColor: Colors.orangeAccent,
                                selectedTileColor: Colors.orangeAccent,
                  ...
                  QuestionContainer(
                      child: Column(
                        children: [
                          const QuestionName(
                              questionName:
                              PhysicalInfrastructureQuestion.typeOfComplaints),
                  ...
                  QuestionContainer(
                      child: Column(
                        children: [
                          const QuestionName(
                              questionName:
                              PhysicalInfrastructureQuestion.complaintsRedressedTime),
                  ...
                  QuestionContainer(
                      child: Column(
                        children: [
                          const QuestionName(
                              questionName:
                              PhysicalInfrastructureQuestion.sourceOfElectricity),
                  ...
                  QuestionContainer(
                      child: Column(
                        children: [
                          const QuestionName(
                              questionName:
                              PhysicalInfrastructureQuestion.electricityConnection),
                  ...
                  QuestionContainer(
                      child: Column(
                        children: [
                          const QuestionName(
                              questionName:
                              PhysicalInfrastructureQuestion.powerCutDuration),
                  ...
                  QuestionContainer(
                      child: Column(
                        children: [
                          const QuestionName(
                              questionName: PhysicalInfrastructureQuestion
                                  .availabilityOfStreetLights),
                          for (var i = 0; i < qtnChoYesNo.length; i++)
                            RadioListTile(
                                tileColor: Colors.orangeAccent,
                                selectedTileColor: Colors.orangeAccent,
                  ...
                  qtnGrpVal12 == "Yes"
                      ...
                      child: Column(
                        children: [
                          const QuestionName(
                              questionName: PhysicalInfrastructureQuestion.ifYes),
                  ...
                  QuestionContainer(
                      child: Column(
                        children: [
                          const QuestionName(
                              questionName:
                              PhysicalInfrastructureQuestion.typeOfStreetLights),
                  ...
                  QuestionContainer(
                      child: Column(
                        children: [
                          const QuestionName(
                              questionName:
                              PhysicalInfrastructureQuestion.householdWasteQater),
                  ...
                  QuestionContainer(
                      child: Column(
                        children: [
                          const QuestionName(
                              questionName:
                              PhysicalInfrastructureQuestion.stormRainWaterCollected),
                  ...
                  QuestionContainer(
                      child: Column(
                        children: [
                          const QuestionName(
                              questionName:
                              PhysicalInfrastructureQuestion.isSolidWasteSegregation),
                          for (var i = 0; i < qtnChoYesNo.length; i++)
                            RadioListTile(
                                tileColor: Colors.orangeAccent,
                                selectedTileColor: Colors.orangeAccent,
