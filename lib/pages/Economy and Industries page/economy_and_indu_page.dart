...
class EconomyAndIndustriesPage extends StatefulWidget {
  ...
  @override
  _EconomyAndIndustriesPageState createState() => _EconomyAndIndustriesPageState();
}
...
class _EconomyAndIndustriesPageState extends State<EconomyAndIndustriesPage> {
  ...
  TextEditingController whichTypeIndustryCompanyController = TextEditingController();
  ...
  TextEditingController typeEmploymentControllerAnother = TextEditingController();
  ...
  List questionChoicesConstruction = ["Daily Wedged", "Weekly Wedged", "Engaged with Contractor"];
  List questionChoicesIndustrial = ["Small Scale", "Medium Scale", "Large Scale"];
  List questionChoicesJobOpportunity = ["Increase", "Decrease"];
  List questionChoicesAfterJobOpportunity = ["Increased", "Decreased", "No Changes"];
  List questionChoicesShopping = ["Online shopping", "Offline Shopping"];
  List questionChoicesOnlineShopping = ["Once in a week", "Twice in a week", "Once in a month", "Very rare"];
  List questionChoicesVisitMarket = ["Once in a week", "Twice in a week", "Once in a month", "Very often"];
  List questionChoicesMonthlyExp = ["Upto Rs 10,000", "Rs 10,000 Rs 20,000", "Rs 20,000 and Above"];
  ...
  void setData() {
    ...
    question1GroupValue = surveyModel.typeOfEmploymentEngagement;
    question2GroupValue = surveyModel.occupation;
    questionGroupValueConstruction = surveyModel.ifConstructionWorker;
    questionGroupValueIndustrial = surveyModel.ifIndustrialWorkerInWhichIndustryDoYouWork;

    questionGrpAnotherFamily = surveyModel.ifThereIsAnotherFamilyMemberWhoIsEmployed;
    questionGrpAnotherEmployee = surveyModel.typeOfEmploymentEngagementAnotherFamilyMember;
    questionGrpAnotherEmployeeOcc = surveyModel.occupationAnotherFamilyMember;
    questionGroupValueConstructionFamilyMember = surveyModel.ifConstructionWorkerAnotherFamilyMember;

    questionGroupValueIndustrialFamilyMember = surveyModel.ifIndustrialWorkerAnotherFamilyMember;

    questionGroupValueFamilyMember = surveyModel.isAnyOfTheFamilyMembersWorkingAsPartTimeEmployees;

    whichTypeIndustryCompanyController.text = surveyModel.ifYesWhichTypeOfIndustryCompanyOffice;

    questionGroupValueJobOpportunity = surveyModel.afterCovid19ImpactOnJobOpportunityAvailability;

    questionGroupValueIndustrialSectorAffected = surveyModel.doesTheIndustrialSectorBeenAffectedAfterCovid19;

    suggestionJobController.text = surveyModel.suggestionsForHowJobOpportunitiesCanBeMadeAvailable;

    questionGroupValueReceivePension = surveyModel.doesAnyFamilyMemberReceiveAPension;
    ifYesSpecifyWhich.text = surveyModel.ifYesSpecifyWhich;
    questionGroupValueMonthlyExp = surveyModel.whatIsYourMonthlyExpenditure;

    questionGroupValueAfterJobOpportunity = surveyModel.impactOnMonthlyExpenditureAfterCovid19;

    questionGroupValueVisitMarket = surveyModel.howOftenYouVisitTheMarketBeforeCovid19;

    questionGroupValueAfterVisitMarket = surveyModel.howOftenYouVisitTheMarketAfterCovid19;

    questionGroupValueAfterShopping = surveyModel.mostPreferredWayOfShoppingAfterCovid19;

    questionGroupValueBeforeShopping = surveyModel.mostPreferredWayOfShoppingBeforeCovid19;
    questionGroupValueOnlineShopping = surveyModel.howOftenDoYouDoOnlineShopping;
  }
  ...
  Future postMethod() async {
    try {
      ...
      var data = {
        ...
        "if_industrial_worker_in_which_industry_do_you_work": questionGroupValueIndustrial,
        "if_there_is_another_family_member_who_is_employed": questionGrpAnotherFamily,
        "type_of_employment_engagement_another_family_member": questionGrpAnotherEmployee,
        "occupation_another_family_member": questionGrpAnotherEmployeeOcc,
        "if_construction_worker_another_family_member": questionGroupValueConstructionFamilyMember,
        "if_industrial_worker_another_family_member": questionGroupValueIndustrialFamilyMember,
        "is_any_of_the_family_members_working_as_part_time_employees": questionGroupValueFamilyMember,
        "if_yes_which_type_of_industry_company_Office": whichTypeIndustryCompanyController.text,
        "after_covid19_impact_on_job_opportunity_Availability": questionGroupValueJobOpportunity,
        "does_the_industrial_sector_been_affected_after_covid19": questionGroupValueIndustrialSectorAffected,
        "suggestions_for_how_job_opportunities_can_be_made_available": suggestionJobController.text,
        "does_any_family_member_receive_a_pension": questionGroupValueReceivePension,
        "if_yes_specify_which": ifYesSpecifyWhich.text,
        "what_is_your_monthly_expenditure": questionGroupValueMonthlyExp,
        "impact_on_monthly_expenditure_after_covid19": questionGroupValueAfterJobOpportunity,
        "how_often_you_visit_the_market_before_covid19": questionGroupValueVisitMarket,
        "how_often_you_visit_the_market_after_covid19": questionGroupValueAfterVisitMarket,
        "most_preferred_way_of_shopping_after_covid19": questionGroupValueAfterShopping,
        "most_preferred_way_of_shopping_before_covid19": questionGroupValueBeforeShopping,
      ...
      if (deviceResponseEconomy.data[0].economy_status == "1" || deviceResponseEconomy.data[0].economy_status != null) {
        ...
        print(surveyId);
        print(data);
        response = await http.put(Uri.parse('http://13.232.140.106:5000/rsi-field-force-api/economy?survey_id=$surveyId'),
            headers: <String, String>{
              'Content-Type': 'application/json; charset=UTF-8',
            },
        ...
        response = await http.post(Uri.parse('http://13.232.140.106:5000/rsi-field-force-api/economy'),
            headers: <String, String>{
              'Content-Type': 'application/json; charset=UTF-8',
            },
            body: json.encode(data));
          ...
          questionBody: Column(
            children: [
              ...
              QuestionContainer(
                  child: Column(
                children: [
                  const QuestionName(questionName: EconomyAndIndustriesQuestion.typeOfEmployment),
              ...
              QuestionContainer(
                  child: Column(
                children: [
                  const QuestionName(questionName: EconomyAndIndustriesQuestion.occupation),
              ...
              question2GroupValue == "Construction worker"
                  ? QuestionContainer(
                      child: Column(
                      children: [
                        QuestionName(questionName: EconomyAndIndustriesQuestion.ifConstructionWorker),
                        for (var i = 0; i < questionChoicesConstruction.length; i++)
                          RadioListTile(
                              tileColor: Colors.orangeAccent,
                              selectedTileColor: Colors.orangeAccent,
                              activeColor: Colors.deepOrange,
              ...
              question2GroupValue == "Industrial worker"
                  ? QuestionContainer(
                      child: Column(
                      children: [
                        const QuestionName(questionName: EconomyAndIndustriesQuestion.ifConstructionWorker),
              ...
              QuestionContainer(
                  child: Column(
                children: [
                  QuestionName(questionName: EconomyAndIndustriesQuestion.anyAnotherFamilyEmployed),
              ...
              questionGrpAnotherFamily == "Yes"
                  ? QuestionContainer(
                      child: Column(
                      children: [
                        const QuestionName(questionName: EconomyAndIndustriesQuestion.typeOfEmploymentAnother),
              ...
              questionGrpAnotherFamily == "Yes"
                  ? QuestionContainer(
                      child: Column(
                      children: [
                        const QuestionName(questionName: EconomyAndIndustriesQuestion.occupationAnother),
                        for (var i = 0; i < question2Choices.length; i++)
                          RadioListTile(
                              tileColor: Colors.orangeAccent,
                              selectedTileColor: Colors.orangeAccent,
              ...
              (questionGrpAnotherEmployeeOcc == "Construction worker")
                  ? QuestionContainer(
                      child: Column(
                      children: [
                        const QuestionName(questionName: EconomyAndIndustriesQuestion.ifConstructionWorkerAnother),
                        for (var i = 0; i < questionChoicesConstruction.length; i++)
                          RadioListTile(
                              tileColor: Colors.orangeAccent,
                              selectedTileColor: Colors.orangeAccent,
                              ...
                              value: questionChoicesConstruction[i].toString(),
                              groupValue: questionGroupValueConstructionFamilyMember,
                              onChanged: (val) {
                                setState(() {
                                  questionGroupValueConstructionFamilyMember = val.toString();
                                  print(questionGroupValueConstructionFamilyMember);
                                });
                              }),
                      ],
                    ))
              ...
              (questionGrpAnotherEmployeeOcc == "Industrial worker")
                  ? QuestionContainer(
                      child: Column(
                      children: [
                        const QuestionName(questionName: EconomyAndIndustriesQuestion.ifIndustrialWorkerAnother),
                        for (var i = 0; i < questionChoicesIndustrial.length; i++)
                          RadioListTile(
                              tileColor: Colors.orangeAccent,
                              selectedTileColor: Colors.orangeAccent,
                              ...
                              value: questionChoicesIndustrial[i].toString(),
                              groupValue: questionGroupValueIndustrialFamilyMember,
                              onChanged: (val) {
                                setState(() {
                                  questionGroupValueIndustrialFamilyMember = val.toString();
              ...
              QuestionContainer(
                  child: Column(
                children: [
                  const QuestionName(questionName: EconomyAndIndustriesQuestion.familyMemberPartTime),
                  for (var i = 0; i < questionAnotherFamily.length; i++)
                    RadioListTile(
                        tileColor: Colors.orangeAccent,
                        selectedTileColor: Colors.orangeAccent,
              ...
              questionGroupValueFamilyMember == "Yes"
                  ? QuestionContainer(
                      child: Column(
                      children: [
                        QuestionName(questionName: EconomyAndIndustriesQuestion.ifYesWhichIndustry),
                        TextFieldContainer(
...
/*--TODO: OnlyRadio...--*/
              QuestionContainer(
                  child: Column(
                children: [
                  const QuestionName(questionName: EconomyAndIndustriesQuestion.afterCovidImpactJob),
              ...
              QuestionContainer(
                  child: Column(
                children: [
                  const QuestionName(questionName: EconomyAndIndustriesQuestion.industrialSectorAffect),
                  for (var i = 0; i < question6Choices.length; i++)
                    RadioListTile(
                        ...
                        onChanged: (val) {
                          setState(() {
                            questionGroupValueIndustrialSectorAffected = val.toString();
              ...
              QuestionContainer(
                  child: Column(
                children: [
                  const QuestionName(questionName: EconomyAndIndustriesQuestion.suggestionsHowJob),
                  TextFieldContainer(
              ...
              QuestionContainer(
                  child: Column(
                children: [
                  const QuestionName(questionName: EconomyAndIndustriesQuestion.familyMemberReceivePension),
                  for (var i = 0; i < question6Choices.length; i++)
                    RadioListTile(
                        tileColor: Colors.orangeAccent,
                        selectedTileColor: Colors.orangeAccent,
              ...
              questionGroupValueReceivePension == "Yes"
                  ? QuestionContainer(
                      child: Column(
                      children: [
                        const QuestionName(questionName: EconomyAndIndustriesQuestion.ifYesSpecifyWhich),
                        TextFieldContainer(
              ...
              QuestionContainer(
                  child: Column(
                children: [
                  const QuestionName(questionName: EconomyAndIndustriesQuestion.whatMonthly),
              ...
              QuestionContainer(
                  child: Column(
                children: [
                  QuestionName(questionName: EconomyAndIndustriesQuestion.impactOnMonthly),
                  for (var i = 0; i < questionChoicesAfterJobOpportunity.length; i++)
                    RadioListTile(
                        tileColor: Colors.orangeAccent,
                        selectedTileColor: Colors.orangeAccent,
                        activeColor: Colors.deepOrange,
                        ...
                        onChanged: (val) {
                          setState(() {
                            questionGroupValueAfterJobOpportunity = val.toString();
              ...
              QuestionContainer(
                  child: Column(
                children: [
                  const QuestionName(questionName: EconomyAndIndustriesQuestion.howOftenBeforeCovid),
              ...
              QuestionContainer(
                  child: Column(
                children: [
                  const QuestionName(questionName: EconomyAndIndustriesQuestion.howOftenAeforeCovid),
                  for (var i = 0; i < questionChoicesVisitMarket.length; i++)
                    RadioListTile(
                        tileColor: Colors.orangeAccent,
                        selectedTileColor: Colors.orangeAccent,
              ...
              QuestionContainer(
                  child: Column(
                children: [
                  const QuestionName(questionName: EconomyAndIndustriesQuestion.margetAfterCovid),
              ...
              QuestionContainer(
                  child: Column(
                children: [
                  const QuestionName(questionName: EconomyAndIndustriesQuestion.margetBeforeCovid),
                  for (var i = 0; i < questionChoicesShopping.length; i++)
                    RadioListTile(
                        tileColor: Colors.orangeAccent,
                        selectedTileColor: Colors.orangeAccent,
              ...
              QuestionContainer(
                  child: Column(
                children: [
                  const QuestionName(questionName: EconomyAndIndustriesQuestion.howOftenOnlineShopping),
              ...
              ButtonBack(onPress: () async {
                ...
                if (statusOf == "pending_survey") {
                  ...
                  Navigator.push(context, MaterialPageRoute(builder: (context) => HousingPage(surveyId: widget.surveyId,)));
                } else {
