            ...
            if (snapshot.hasData) {
              return ListView.builder(
                  ...
                  itemBuilder: (BuildContext context, index) {
                    ...
                    if (userData[index].user_family_status != "1" &&
                            userData[index].household_status != "1" ||
                      ...
                      return InkWell(
                          onTap: () async {
                            ...
                            _pref.setString(
                                'survey_id', userData[index].surveyId);
                            if (userData[index].user_family_status != "1" ||
                                userData[index].user_family_status == null) {
                              print("1");
                              Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                      builder: (context) =>
                                          UserDetailsBuilder()));
                            } else if (userData[index].household_status !=
                                    "1" ||
                                userData[index].household_status == null) {
                              print("2");
                              Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                      builder: (context) =>
                                          HouseHoldPofilePage()));
                            } else if (userData[index].housing_status != "1" ||
                                userData[index].housing_status == null) {
                              print("3");
                              Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                      builder: (context) => HousingPage()));
                            } else if (userData[index].economy_status != "1" ||
                                userData[index].economy_status == null) {
                              print("4");
                              Navigator.push(
                                  context,
                                  MaterialPageRoute(
                            ...
                            } else if (userData[index].transportation_status !=
                                    "1" ||
                                userData[index].transportation_status == null) {
                              print("5");
                              Navigator.push(
                                  context,
                                  MaterialPageRoute(
                              ...
                              Navigator.push(
                                  ...
                                  MaterialPageRoute(
                                      builder: (context) =>
                                        ...
                                        .social_infrastructure_status !=
                                    "1" ||
                                userData[index].social_infrastructure_status ==
                                    null) {
                              print("7");
                              Navigator.push(
                                  context,
                            ...
                            } else if (userData[index].slums_status != "1" ||
                                userData[index].slums_status == null) {
                              print("8");
                              Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                      builder: (context) => SlumsPage()));
                            } else if (userData[index].coastal_status != "1" ||
                                userData[index].coastal_status == null) {
                              print("9");
                              Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                    ...
                                    "1" ||
                                userData[index].cultural_heritage_status ==
                                    null) {
                              print("10");
                              Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                      builder: (context) =>
                                          CulturalAndHeritage()));
                            } else if (userData[index].tourism_status != "1" ||
                                userData[index].tourism_status == null) {
                              print("11");
                              Navigator.push(
                                  context,
                                  MaterialPageRoute(
